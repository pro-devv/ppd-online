            ...
            <div class="col-lg-9 ">
                @auth
                    ...
                    <form class="row contact_form" action="{{ route('kirim-tiket.store') }}" method="post" id="contactForm" enctype="multipart/form-data">
                        @csrf
                        <div class="col-lg-6">
                            <input type="text" readonly class="form-control" id="nama" name="nama" value="{{ Auth::user()->name }}" placeholder="Masukkan Email">
                        </div>
                        <div class="col-lg-6">
                            <input type="text" readonly class="form-control" id="nama" name="nama" value="{{ Auth::user()->email }}" placeholder="Masukkan Email">
                        </div>
